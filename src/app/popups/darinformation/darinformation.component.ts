...
@Component({
  selector: 'app-darinformation',
  templateUrl: './darinformation.component.html',
  styleUrls: ['./darinformation.component.scss'],
})
export class DarinformationComponent implements OnInit {
  accid:any;
...
let postDate = {
   ...
   onSubmit(){
       ...
       //return false;
        ...
        this.api.darsave('darforward',postDate).subscribe((data: any)=>{
