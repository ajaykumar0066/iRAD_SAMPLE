...
@Component({
  selector: 'app-darlist',
  templateUrl: './darlist.page.html',
  styleUrls: ['./darlist.page.scss'],
})
export class DarlistPage implements OnInit {
...
getRows() {
 ...
 `, [])
  ...
  funPending(offset){
    ...
    this.api.post('darlist',postDate).subscribe((data: any)=>{
