...
@Component({
  selector: 'app-legallist',
  templateUrl: './legallist.page.html',
  styleUrls: ['./legallist.page.scss'],
})
export class LegallistPage implements OnInit {
...
getRows() {
 ...
 `, [])
  ...
  funPending(offset){
    ...
    this.api.post('legal',postDate).subscribe((data: any)=>{
