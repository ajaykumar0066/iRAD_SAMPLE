...
@Component({
  selector: 'app-addprojuser',
  templateUrl: './addprojuser.component.html',
  styleUrls: ['./addprojuser.component.scss'],
})
export class AddprojuserComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (this.user.role == 1) {
      this.title = 'State User for '
    } else if (this.user.role == 2) {
      this.title = 'District User for'
    } else if (this.user.role == 3) {
      this.title = 'Station User for '
