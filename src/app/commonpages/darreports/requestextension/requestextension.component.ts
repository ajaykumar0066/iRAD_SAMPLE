...
@Component({
  selector: 'app-requestextension',
  templateUrl: './requestextension.component.html',
  styleUrls: ['./requestextension.component.scss'],
})
export class RequestextensionComponent implements OnInit {
  ...
  data={accid:'',formno:'',reason:'',days:''} ; selacc:any;
...
closeModal() {
  ...
  reqEXPDF(id){
    ...
    let ln='en';
    let pdfurl=environment.apiUrl+'reports/darreqex.php?ln='+ln+'&id='+id;
